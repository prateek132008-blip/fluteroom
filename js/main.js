  ...
  function openRazorpayCheckout(data, meta) {
    ...
    const options = {
      ...
      handler: function (response) {
        ...
        const successStorageKey = "tfr_success_payload";
        sessionStorage.setItem(successStorageKey, JSON.stringify(successPayload));
        localStorage.setItem(successStorageKey, JSON.stringify(successPayload));
